...
// CODE HERE
let faveColors = ["green","yellow","purple"]
//////////////////Step 2////////////////////
...
let me = {
    firstName: "Garrett",
    superHeroName: "Garrett the Great",
    homeTown: "Washington",
    superPowers: ["coding","animal loving","making food disappear"],
    superPowerXP: function number (){ return Math.floor(Math.random() * 100) + 1},
    profileImage:  function pic(){
